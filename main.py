...
from train import run_clip

def main():
    args = get_arguments()
    set_random_seed(args.seed)
    clip_model, preprocess = clip.load(args.backbone, args.device)
    clip_model.eval()
    logit_scale = 100
    ...
    run_clip(args, clip_model, logit_scale, dataset, train_loader, test_loader)
